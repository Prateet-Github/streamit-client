const AuthLeft = () => {
  return (
    <section className="hidden md:flex relative items-center justify-center w-1/2 bg-emerald-500 overflow-hidden">
      <div className="z-10 w-[85%] h-[85%] max-h-175 bg-white/10 backdrop-blur-2xl border border-white/20 rounded-[40px] p-1 shadow-2xl overflow-hidden">
        <div className="relative w-full h-full bg-zinc-950/90 rounded-[36px] flex flex-col p-12">
          <div className="flex items-center gap-4 text-emerald-400 text-4xl font-black tracking-tighter">
            <div className="flex items-center justify-center w-12 h-12 bg-emerald-500 rounded-2xl  transition-transform hover:scale-110 cursor-pointer">
          ...
          <div className="mt-auto">
            ...
            <h2 className="text-white text-5xl font-bold leading-[1.1] mb-6">
              ...
              <span className="text-emerald-400">global</span> platform.
            </h2>
